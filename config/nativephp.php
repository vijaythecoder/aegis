...
return [
    ...
    'deeplink_scheme' => env('NATIVEPHP_DEEPLINK_SCHEME', 'aegis'),

    'author' => env('NATIVEPHP_APP_AUTHOR', 'Aegis Team'),

    'copyright' => env('NATIVEPHP_APP_COPYRIGHT', 'Copyright (c) 2026 Aegis. MIT License.'),

    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Aegis — AI under your Aegis. Secure AI agent platform.'),

    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://github.com/AegisApp/aegis'),
